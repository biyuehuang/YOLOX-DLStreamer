...
def main():
    ...
    pipeline_str = "filesrc location={} ! decodebin ! videoconvert ! video/x-raw,format=BGRx ! " \
        "gvainference name=gvainference model={} model-proc=/home/adc-iot/Downloads/dependency/openvino_models/models/public/yolox_dark/yolox.json pre-process-backend=opencv device=GPU inference-interval=3 ! queue ! " \
